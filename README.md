...
| **`legal-argentina`** | "términos y condiciones", "política de privacidad", "botón de arrepentimiento", "auditá mis legales" | Terms, privacy and security policy for products operating in **Argentina**, deduced from the real schema, providers and pixels — plus an audit mode that compares the published legal text against the code. **Argentina only**; it says so rather than pretending to cover GDPR. |
...
### ⚠️ `legal-argentina` and the shelf life of law

Legal content expires. The normative tables in `legal-argentina` were **verified against
primary sources on 2026-08-17** (InfoLeg, Boletín Oficial, argentina.gob.ar), and the skill
...
| `legal-argentina` | Ley 25.326, Ley 24.240, CCyC arts. 1092-1122, Res. AAIP 47/2018, Res. AAIP 126/2024, Disp. DNPDP 60/2016 + Res. AAIP 34/2019, Disposición 954/2025, Decreto 55/2025 — all verified against InfoLeg / Boletín Oficial / argentina.gob.ar |
